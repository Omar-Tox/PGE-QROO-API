...
def analisis_presupuestal_trimestral(db: Session, ids_dependencias: List[int], anio: int) -> Dict:
    ...
    # 2. Obtener Gasto Real (Agrupado por Trimestre derivado del mes)
    # Mapeo manual de Mes a Trimestre en Python para compatibilidad simple
    # Q1: 1,2,3 | Q2: 4,5,6 | Q3: 7,8,9 | Q4: 10,11,12
    
    # Primero traemos los edificios de estas dependencias para filtrar el consumo
